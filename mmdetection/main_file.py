...
parser.add_argument('--config_path', type=str, default='/opt/ml/baseline/mmdetection/configs/_custom_/faster_rcnn/faster_rcnn_r101_fpn_1x_coco.py', help='path to config file')  
