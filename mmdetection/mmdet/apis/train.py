...
def train_detector(model,
    ...
    if validate:
        ...
        if val_dataloader_args['samples_per_gpu'] > 1:
            ...
            # <class 'mmdet.datasets.coco.CocoDataset'>
        ...
        # {'interval': 1, 'metric': 'bbox'} eval_cfg

        eval_cfg['by_epoch'] = cfg.runner['type'] != 'IterBasedRunner'
        # print(cfg.runner['type'])
        #EpochBasedRunner cfg.runner['type']

        # print(EvalHook)
        # print(DistEvalHook)
        # <class 'mmdet.core.evaluation.eval_hooks.EvalHook'>
        # <class 'mmdet.core.evaluation.eval_hooks.DistEvalHook'>
